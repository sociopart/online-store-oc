...
$_['text_subscription_description'] = '%s каждый %d %s(й) для %d платежа(й)';
...
$_['entry_subscription']     = 'Профиль периодичности';
...
$_['error_keyword']          = 'SEO URL должен быть уникальным!';
